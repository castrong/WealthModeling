...
# ╔═╡ c465ccea-394b-11ed-0601-978a2a208b8e
using Plots, Graphs, GraphPlot, Compose

# ╔═╡ 836c56ee-c620-48c6-ba22-1a6d80e8e25e
md"""
##### Create a simple graph
"""

# ╔═╡ beaae8fe-5f61-4901-af65-06b4321bcd00
g = star_graph(6)

# ╔═╡ a674cdf5-a78c-41a5-94a3-f441f0a97940
gplot(g, nodelabel=1:nv(g))

# ╔═╡ 926ae13c-320f-4ab5-816d-2a9a161bdca6
md"""
##### Define parameters for the dynamics.
"""

# ╔═╡ b7b27a60-3265-4d0e-bcb4-8efd0dae9638
c_neighbor = [1; 1; 1]; # Feedback from neighbors to Δx

# ╔═╡ 8306d6df-3eb4-424c-96a4-8e9df4a16ae6
c_self = [0.1; 0.1; 0.1]; # Feedback from self to Δx

# ╔═╡ d34dd81f-8db8-41d8-bf55-fb15eb369b61
α = 0.9; # 

# ╔═╡ 053e8a28-a0d9-4f3c-8dd2-2d991f83829b
md"""
##### Generate initial conditions
"""

# ╔═╡ 882f560b-127d-48a1-9ccb-dba2f8fa1a99
num_nodes = nv(g)

# ╔═╡ c1cb6c9c-c868-4090-8b6d-6c9eb5c1ef55
X₀ = [for i = 1:num_nodes] # (num_state per node x num_node matrix) of initial conditions
